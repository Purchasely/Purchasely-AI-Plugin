...
4. **Check default presentation dismiss handler** -- `setDefaultPresentationDismissHandler` (v6 rename of v5's `setDefaultPresentationResultHandler`) must be configured, or the SDK has nowhere to send deeplink paywall results.
