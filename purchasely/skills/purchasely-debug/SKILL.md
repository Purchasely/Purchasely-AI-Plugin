...
- Confirm the SDK generation: native iOS uses v6 (`6.0.0`, stable GA); native Android uses v6 (`6.0.1`, stable GA — Android never had a `6.0.0` tag, the line went rc.1 → rc.2 → rc.3 → `6.0.1`); Flutter uses v6 (`6.0.0`, pulling native iOS `6.0.0` + Android core `6.0.1`); React Native uses v6 (`6.0.0`, stable GA, npm `latest`, pulling native iOS `6.0.0` / Android `6.0.1`); Cordova uses v6 (`6.0.0-rc.3`, npm dist-tag `next`, pulling native iOS/Android `6.0.0-rc.3`).
