...
- v5 tokens (Cordova is still v5; on all v6 SDKs these are **removed** with no alias — FLAG on any v6 native/Flutter/React Native code): `isDeeplinkHandled` / `readyToOpenDeeplink`
