...
| Plugin alignment | Cross-platform: a `react-native-purchasely 6.0.0-rc.3` + `@purchasely/react-native-purchasely-google 5.6.0` mismatch produces silent rendering bugs — pin every Purchasely package to the exact same version |
